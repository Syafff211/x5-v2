...
const QUICK_ACTIONS = [
  ...
  { label: 'Buat Tugas', href: '/admin/assignments', icon: ClipboardList, accent: 'from-sky-500 to-blue-500' },
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div className="relative">
          ...
          <p className="mt-2 text-sm text-white/85">
            {ungraded.length > 0
              ? `Ada ${ungraded.length} pengumpulan tugas yang menunggu penilaian.`
              : 'Semua tugas sudah dinilai. Panel kelas dalam kondisi baik.'}
          </p>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        />
        <StatCard label="Tugas Aktif" value={activeAssignments.length} icon={ClipboardList} accent="sky" trend={`${ungraded.length} perlu dinilai`} />
