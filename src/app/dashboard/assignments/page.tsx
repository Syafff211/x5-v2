...
export default function AssignmentsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Tugas" description="Daftar tugas kelas, deadline, dan status pengumpulan." />
      ...
      {list.length === 0 ? (
        <EmptyState icon={ClipboardList} title="Tidak ada tugas" description="Belum ada tugas pada kategori ini." />
      ) : (
